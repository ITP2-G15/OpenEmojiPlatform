...
Either pair up your Android phone [here](https://developer.android.com/studio/run/device) or set up a virtual device [here](https://developer.android.com/studio/run/managing-avds). Then press the Run button. The app should start on the device.
...
```json
{
  ...
  "tasks": [
    ...
    },
    {
      "label": "build",
      "type": "shell",
      "command": "./gradlew installDebug && adb shell am start -n com.platform.openemoji/.MainActivity",

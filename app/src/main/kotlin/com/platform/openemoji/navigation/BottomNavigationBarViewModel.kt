...
class BottomNavigationBarViewModel : ViewModel() {
    ...
    private val currentSelectedTab = MutableStateFlow<BottomNavigationBarTab?>(null)
    ...
    private val lastNavigatedTab = MutableStateFlow<BottomNavigationBarTab?>(null)
    ...
    fun selectTab(
        ...
        currentSelectedTab.value = BottomNavigationBarTab(orderValue, screen)
    }
